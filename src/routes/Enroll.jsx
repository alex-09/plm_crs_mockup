...
import ViewSched from './enroll/ViewSched';
import ViewAssess from './enroll/ViewAssess';
    ...
    <>
      ...
      <main>
        ...
        <h1 className="font-sans text-3xl font-bold text-plm-gold mt-10 mb-5">
            {activeStep === 1 ? 'SCHEDULE' : activeStep === 2 ? 'ASSESSMENT' : 'REGISTER'}
        </h1>

        <div className="divide-y divide-slate-500">
            {activeStep === 1 && <ViewSched />}
            {activeStep === 2 && <ViewAssess />}
            {activeStep === 3 && <Register />}
        </div>
